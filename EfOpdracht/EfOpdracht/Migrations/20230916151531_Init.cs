    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 404 });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "EmployeeNumber", "Firstname", "Lastname" },
                values: new object[] { 1, 400, "Fatalis", "Elder" });

            migrationBuilder.InsertData(
                table: "Students",
                columns: new[] { "Id", "BirthDate", "FirstName", "GroupId", "LastName", "StudentNumber", "TeacherId" },
                values: new object[] { 1, new DateTime(1999, 5, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Rathalos", 1, "Rath", 10, 1 });
